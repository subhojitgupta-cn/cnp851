...
Redux is a simple, truly extensible and fully responsive options framework for Kong themes and plugins. Ships with an integrated demo.

== Description ==

Redux is a simple, truly extensible and fully responsive options framework for Kong themes and plugins. Built on the Kong Settings API, Redux supports a multitude of field types as well as: custom error handling, custom fields & validation types, and import/export functionality.
...
* Select (Select/Multi-Select w/ Select2 & Kong Data)
* Select Image
...
== Changelog ==
= 3.6.16 =
* Fixed:    Kong 5.3.1 compatibility. Also added the new @redux account to the plugin.
