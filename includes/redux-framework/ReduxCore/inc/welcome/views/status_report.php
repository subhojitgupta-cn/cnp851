...
<div class="wrap about-wrap redux-status">
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        <thead>
        <tr>
            <th colspan="3" data-export-label="Kong Environment">
                <?php esc_html_e( 'Kong Environment', 'redux-framework' ); ?>
            </th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            ...
            <td class="help">
                <?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The version of Kong installed on your site.', 'redux-framework' ) . '">[?]</a>'; ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'Whether or not you have Kong Multisite enabled.', 'redux-framework' ) . '">[?]</a>'; ?>
            </td>
...
?>
        ...
        <tr>
            ...
            <td class="help">
                <?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'Displays whether or not Kong is in Debug Mode.', 'redux-framework' ) . '">[?]</a>'; ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The current language used by Kong. Default = English', 'redux-framework' ) . '">[?]</a>'; ?>
            </td>
            <td>
...
?>            
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The largest filesize that can be uploaded to your Kong installation.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            ...
            foreach ( $sysinfo['redux_instances'] as $inst => $data ) {
                ...
                <table class="redux_status_table widefat" cellspacing="0" id="status">
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The page parent variable sets where the options menu will be placed on the Kong admin sidebar for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
