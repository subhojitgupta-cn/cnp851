<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Kong Editor', 'redux-framework-demo' ),
        'id'         => 'editor-wordpress',
        //'icon'  => 'el el-home'
        ...
        'fields'     => array(
            array(
                ...
                'subtitle' => __( 'Use any of the features of Kong editor inside your panel!', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'subtitle' => __( 'Create a new Gallery by selecting existing or uploading new images using the Kong native uploader', 'redux-framework-demo' ),
                'desc'     => __( 'This is the description field, again good for additional info.', 'redux-framework-demo' ),
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'subtitle' => __( 'Upload any media using the Kong native uploader', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'   => 'opt-info',
                'type' => 'info',
                'desc' => __( 'You can easily add a variety of data from Kong.', 'redux-framework-demo' ),
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        // 'submenu' => false, // Setting submenu to false on a given section will hide it from the Kong sidebar menu!
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'       => __( 'These fields can be fully translated by WPML (Kong Multi-Language). This serves as an example for you to implement. For extra details look at our <a href="//docs.reduxframework.com/core/advanced/wpml-integration/" target="_blank">WPML Implementation</a> documentation.', 'redux-framework-demo' ),
        'subsection' => true,
        // 'submenu' => false, // Setting submenu to false on a given section will hide it from the Kong sidebar menu!
        'fields'     => array(
            array(
